...
if __name__ == "__main__":
    ...
    parser.add_argument("-src", "--src_file", dest="src_file", default="./test_src.txt", help="src file")
    parser.add_argument("-tgt", "--tgt_file", dest="tgt_file", default="./test_tgt.txt", help="target file")
