...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_loader = get_loader(config.train_src_file,
                                       ...
                                       config.train_bio_file,
                                       config.train_adj_file,
                                       config.train_ner_file,
                                       config.train_an_file,
                                       config.train_pos_file,
                                       word2idx,
                                       use_tag=True,
...
#===============================================================
    ...
    def step(self, train_data):
        src_seq, ext_src_seq, trg_seq, ext_trg_seq, tag_seq, _, adj_seq, ner_seq, an_seq, pos_seq = train_data
        ...
        logits = self.model(src_seq, tag_seq, ext_src_seq, trg_seq, adj_seq, ner_seq, an_seq, pos_seq)
