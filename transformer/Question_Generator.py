...
class QuestionGenerator(object):
    ...
    def generate_question_batch(self, src1_seq, src1_pos, src1_emo, src1_bio, src1_bio_pos):
        '''
        ...
        with torch.no_grad():
            ...
            src_enc1 = self.model.gcn(src1_seq, src1_bio, src1_emo)  # (batch, 20, 300)
            ...
            src_seq = src1_seq.repeat(1, n_bm).view(n_inst * n_bm, len_s)  # (batch * 5, 20)
